...
public class EchoMTGJavaAPI {
     ...
     */
    public function EchoMTGJavaAPI(string Email, string Password)
    {
        email = Email;
        password = Password;
    }
